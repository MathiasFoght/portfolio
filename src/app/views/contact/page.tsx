  ...
  return (
      <section className={styles.wrapperContact} id="contact">
        <div className={styles.contactContainer}>
          ...
          <form className={styles.loginForm} onSubmit={handleSubmitWithValidation} noValidate>
            <div className={styles.formInputMaterial}>
              <input
                  ...
                  placeholder=" "
                  autoComplete="name"
                  className={cn(styles.formControlMaterial, { [styles.error]: errors.name })}
                  value={formData.name}
            ...
            <div className={styles.formInputMaterial}>
              <input
                  ...
                  placeholder=" "
                  autoComplete="email"
                  className={cn(styles.formControlMaterial, { [styles.error]: errors.email })}
            ...
            <textarea
                ...
                placeholder=" "
                autoComplete="off"
                className={cn(styles.formControlMaterial, { [styles.error]: errors.message })}
                rows={5}
            ...
            <button
                type="submit"
                className={cn(styles.btn, { [styles.successText]: isSuccess })}
